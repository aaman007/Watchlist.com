        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table">
                        <tr>
                            <td class="col-md-1"> <a href="/users/{{$user->id}}/watching"> <i class="fa fa-circle text-success mr-2"></i> Watching </a> </td>
                            <td class="col-md-1"> {{$watching}} </td>
                        <tr>
                        <tr>
                            <td class="col-md-1"> <a href="/users/{{$user->id}}/completed"> <i class="fa fa-circle text-primary mr-2"></i> Completed </a> </td>
                            <td class="col-md-1"> {{$completed}} </td>
                        <tr>
                        <tr>
                            <td class="col-md-1"> <a href="/users/{{$user->id}}/on-hold"> <i class="fa fa-circle text-info mr-2"></i> On-Hold </a> </td>
                            <td class="col-md-1"> {{$onHold}} </td>
                        <tr>
                        <tr>
                            <td class="col-md-1"> <a href="/users/{{$user->id}}/dropped"> <i class="fa fa-circle text-danger mr-2"></i> Dropped </a> </td>
                            <td class="col-md-1"> {{$dropped}} </td>
                        <tr>
                        <tr>
                            <td class="col-md-1"> <a href="/users/{{$user->id}}/plan-to-watch"> <i class="fa fa-circle text-secondary mr-2"></i> Plan To Watch </a> </td>
